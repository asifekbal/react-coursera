                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" type="text" id="lastname" className="form-control" name="lastname" placeholder="Last Name" />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Label htmlFor="telnum" md={2}>Contact Tel.</Label>
                                <Col md={10}>
                                    <Control.text model=".telnum" type="tel" id="lastname" className="form-control" name="telnum" placeholder="Tel. Number" />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Label htmlFor="email" md={2}>Email</Label>
                                <Col md={10}>
                                    <Control.text model=".email" type="tel" id="email" className="form-control" name="email" placeholder="Email" />
                                </Col>
                            </Row>
                            <Row className="form-group">
